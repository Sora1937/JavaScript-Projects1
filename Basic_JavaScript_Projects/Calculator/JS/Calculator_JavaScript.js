...
const Calculator = {
    // This will display 0 on the calculator
    Display_Value: '0',
    // This will hold the first operand for an expressions, we set it to null for now.
    First_Operand: null,
    // This checks whether or not the second operand has been inputted by th user.
    Wait_Second_Operand: false,
    // This will hold the operator , we set it to null for now.
    operator: null,
};

// This function handles decimal input
function Input_Decimal(dot) {
    // If the Display_Value does not already contain a decimal point, add one.
...
function Handle_Operator(Next_Operator) {
    ...
    // When an operator key is pressed we convert the current numbmer
